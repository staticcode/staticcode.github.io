        ...
        switch(layerName) {
          ...
          case 'panoramio': 
            ...
            case 'places': 
              ...
              //search and  nearbyПоиск callback, Both are the same
              if(options.search || options.nearbyПоиск) {
                var placeПоискRequest  = {
                ...
                if(options.search) {
                  layer.search(placeПоискRequest, options.search);
                }

                if(options.nearbyПоиск) {
                  layer.nearbyПоиск(placeПоискRequest, options.nearbyПоиск);
                }
              }

              //textПоиск callback
              if(options.textПоиск) {
                var textПоискRequest  = {
                  bounds : options.bounds || null,
                  location : options.location || null,
                ...
                layer.textПоиск(textПоискRequest, options.textПоиск);
              }
            break;
        }
