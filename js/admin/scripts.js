var App = function () {
    ...
    var handleFixInputPlaceholderForIE = function () {
        ...
        if ( typeof jQuery.browser != 'undefined' && jQuery.browser.msie && jQuery.browser.version.substr(0, 1) <= 9) { // ie7&ie8
    ...
    var handlePeity = function () {
        ...
        if ( typeof jQuery.browser != 'undefined' && jQuery.browser.msie && jQuery.browser.version.substr(0, 2) <= 8) { // ie7&ie8
            return;
        }
    ...
    var handleTables = function (geo, date) {
        ...
        //('#sample_1').dataTable().fnReloadAjax( '/panel/teaserStats/show' );
                // begin first table
        ...
        //table.fnReloadAjax();
        /*$.post('/panel/teaserStats/show', {'geo':"RU"}, function(result){
            //$(".widget-body").html(result);
            var table1 = $('#sample_1').DataTable().ajax.reload();
        });*/
...
*/
    ...
    return {
        ...
        init: function () {
            ...
            if ( typeof jQuery.browser != 'undefined' && jQuery.browser.msie && jQuery.browser.version.substr(0, 1) == 8) {
