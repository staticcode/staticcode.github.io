...
const Public = (props) => {
  ...
  const geoDataForRender = sortedGeo.slice(0, 5);
  return (
    <div className="public-ig_tmp">
      <div className="public-ig_brief">
        ...
        <div className="public-ig_username clearfix mb1">
          ...
          />
          {!!props.closed && <i className="ion-locked" data-tip="Закрытый аккаунт"/>}
          <div className="ovh">
            <a
  ...
  render() {
    ...
    const costOfPostList = (list) => list.slice(0, limitCostList).map(c => (
      <li className="clearfix" key={c.name}>
        ...
        <div className="left" style={{ width: '38%', whiteSpace: 'nowrap' }}>
          {c.price}
        </div>
