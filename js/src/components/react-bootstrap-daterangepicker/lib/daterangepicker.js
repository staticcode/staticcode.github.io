...
(function(root, factory) {
  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.buttonClasses = 'button __sm';
        this.applyClass = '__success';
        this.cancelClass = '__default';
    ...
    DateRangePicker.prototype = {
        ...
        updateFormInputs: function() {
            ...
            if (this.singleDatePicker || (this.endDate && (this.startDate.isBefore(this.endDate) || this.startDate.isSame(this.endDate)))) {
                this.container.find('button.applyBtn').removeAttr('disabled').removeAttr('title');
            } else {
                this.container.find('button.applyBtn').attr('disabled', 'disabled').attr('title','Нужно выбрать диапазон');
            }
        },
