...
class Searchform extends React.Component {
  ...
  handleReset() {
    ...
    this.setState(
      { value: '' },
      () => {
        window.history.replaceState(null, null, currentPagePath); // http://redmine.pmm.in.ua/issues/5697
        this.props.onSubmit();
      }
    );
  }
  ...
  handleChange(e) {
    ...
    this.setState({ value: e.target.value }); // нужно будет удалить и проверить, что бы нигде ничего не сломалось
  }
