/*! Social Likes v3.0.9 by Artem Sapegin - http://sapegin.github.com/social-likes - Licensed MIT */ ! function(a) {
    ...
    var k = "social-likes",
        ...
        o = {
            ...
            odnoklassniki: {
                counterUrl: "http:" === n ? "http://www.odnoklassniki.ru/dk?st.cmd=extLike&ref={url}&uid={index}" : b,
                counter: function(b, c) {
