...
(function($) {
    $(function() {
        $('div.share42init').each(function(idx) {
            ...
            var l = '';
            for (j = 0; j < s.length; j++) l += '<span class="share42-item"><a rel="nofollow" style="display:inline-block;width:32px;height:32px;margin:0;padding:0;outline:none;background:url(' + f + fn + ') -' + 32 * j + 'px 0 no-repeat" href=' + s[j] + ' target="_blank"></a></span>';
            el.html('<span id="share42">' + l + '</span>' + '');
        });

        $("#share42 .share42-item").on("click", function(){
                $(this).find('a').click();
        });
    })
})(jQuery);